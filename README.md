...
![Demo](https://github.com/user-attachments/assets/82ccd178-b98d-4025-824f-edd5b5aa2df6)

[데모 영상 보기](#) · [발표자료 PDF](./docs/발표자료.pdf) · [블로그 포스트](#)
...
- **개발 기간**: 2026.06 ~ 2026.07 (약 4주간 진행)
...
| **남정희** | OCR 파이프라인(PDF/PPTX 파싱·품질평가), RDB ERD 설계 주도, 요약·분류 LLM 프롬프트, 데이터셋 수집·전처리, 테스트 총괄·PR 통합 관리 |
